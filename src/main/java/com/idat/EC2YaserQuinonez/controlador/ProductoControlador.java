package com.idat.EC2YaserQuinonez.controlador;
...
import com.idat.EC2YaserQuinonez.servicio.ProductoServicio;
...
public class ProductoControlador {
	...
	public ResponseEntity<Void> editar(@RequestBody ProductoDTORequest producto){
		ProductoDTOResponse p = servicio.obtenerProductoId(producto.getIdProducto());
		if(p != null) {
